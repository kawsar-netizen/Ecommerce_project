...
@section('forntend_content')
    ...
    <!-- Hero Section End -->
                ...
                @if(Session::has('cart'))
                    <div>
                        <p class="alert alert-primary">{{ Session::get('cart') }}
                    ...
                    <div class="latest-product__text">
                        ...
                        <div class="latest-product__slider owl-carousel">                       
                            ...
                            @foreach($lts_p as $product)
                                <a href="#" class="latest-product__item">
                                    <div class="latest-product__item__pic">
                                        <img src="{{asset($product->image_one)}}" style="width:40px,height:40px" alt="">
                                    </div>
                            ...
                            @foreach($lts_p as $product)
                                <a href="#" class="latest-product__item">                            
                                    <div class="latest-product__item__pic">
                                        <img src="{{$product->image_one}}" style="withd:40px,height:40px" alt="">
                                    </div>
                                    <div class="latest-product__item__text">
                                        <h6>{{$product->product_name}}</h6>
                                        <span>${{$product->price}}</span>
